This is a guide to replicate the faithfulness results. 

Steps:
    1. Run "1_SVC_text_data_and_preds_faithfulness.ipynb" as is. To train the SVM and generate a CSV-file with LIME explanations for the 50 instances. 
    2. Run "2_CSV_to_Prompt_faithfulness.ipynb" as is. This will generate a CSV-file with prompts. 
    ...
    4. Run "3_Generate_NLE_faithfulness.ipynb". You have now generated natural language explanations. 
